...
class DetailInfo(Login):
    ...
    def detail_info(self, company, area, line, departaddr, departname, salary, homeaddr, url):
        ...
        sleep(1)
        self.login_button((By.XPATH, '/html/body/div[2]/div/div[7]/span'))#行业类别旁边的按钮
        sleep(2)
        self.login_button((By.XPATH, '//*[@id="career"]/div/div[2]/div[2]/ul/li[1]/p'))#行业类别第一个默认行业
        sleep(1)
        self.login_button((By.XPATH, '//*[@id="show"]/span'))
        sleep(1)
        self.login_button((By.XPATH, '/html/body/div[7]/div/div[1]/div/a'))
        sleep(1)
