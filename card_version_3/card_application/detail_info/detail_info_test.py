...
class CardApplicationDetailInfoTest(unit_init.Base):
    ...
    def login(self, company, area, line, departaddr, departname, salary, homeaddr, url):
        CardApplicationDetailInfo(self.driver).open_login(company, area, line, departaddr, departname, salary,
                                                          homeaddr, url)
    ...
    def test_login_detail_home_null(self):
        self.login("上海科技馆有限公", "021", "695169567", "", "业务部", "120", "广兰路200号",
                   CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_home_more(self):
        self.login("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号，浦东新区来安路500号，浦东新区来安路500号", "业务部", "120",
    ...
    def test_login_detail_salary_null(self):
        self.login("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "", "广兰路200号",
                   CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_salary_zero(self):
        self.login("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "0", "广兰路200号",
                   CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_salary_point(self):
        self.login("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "1.5", "广兰路200号",
                   CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
