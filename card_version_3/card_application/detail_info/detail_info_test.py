...
class CardApplicationDetailInfoTest(unit_init.Base):
    ...
    def login_verify(self, company, area, line, departaddr, departname, salary, homeaddr, url):
        CardApplicationDetailInfo(self.driver).fast_detail_info(company, area, line, departaddr, departname, salary,
                                                                homeaddr, url)

    # 正常填写详情页
    def test_login_detail_info(self):
        self.login_verify("上海蓝天科技有限公司", "021", "6951691", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)

    # 详情页的公司名称为空时
    def test_login_detail_name_null(self):
        self.login_verify("", "021", "6951691", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
    ...
    def test_login_detail_name_more(self):
        self.login_verify("上海科技馆有限公司是是是是是是是", "021", "6951691", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_area_miss(self):
        self.login_verify("上海科技馆有限公", "0214", "6951691", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_area_null(self):
        self.login_verify("上海科技馆有限公", "", "6951691", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    # 详情页的区号为英文
    def test_login_detail_area_null(self):
        self.login_verify("上海科技馆有限公", "12m", "6951691", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_phone_english(self):
        self.login_verify("上海科技馆有限公", "021", "695169m", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_phone_chinese(self):
        self.login_verify("上海科技馆有限公", "021", "695169你", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
        self.assertEqual(base_info_label.text, '请输入正确的电话号码')
    ...
    def test_login_detail_phone_null(self):
        self.login_verify("上海科技馆有限公", "021", "", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_phone_miss(self):
        self.login_verify("上海科技馆有限公", "021", "695169", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
        self.assertEqual(base_info_label.text, '请输入正确的电话号码')
    ...
    def test_login_detail_phone_more(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
        self.assertEqual(base_info_label.text, '请输入正确的电话号码')
    ...
    def test_login_detail_home_null(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "", "业务部", "120", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_home_more(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号，浦东新区来安路500号，浦东新区来安路500号", "业务部", "120",
    ...
    def test_login_detail_salary_null(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_salary_zero(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "0", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_salary_point(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "浦东新区来安路500号", "业务部", "1.5", "广兰路200号",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
    ...
    def test_login_detail_address_null(self):
        self.login_verify("上海科技馆有限公", "021", "695169567", "来安路500号", "业务部", "120", "",
                          CardUrl.CARD_APPLICATION_DETAIL_INFO_URL)
        base_info_label = self.driver.find_element_by_xpath('/html/body/div[7]')
        self.assertEqual(base_info_label.text, '详细地址不能为空')
